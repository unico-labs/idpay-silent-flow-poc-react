  ...
  return (
    <header className="bg-white shadow-sm">
      <div className="container mx-auto px-4 py-4 flex flex-col items-center">
        <svg width="120" height="45" viewBox="0 0 260 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <p className="text-sm text-blue-500 mt-1">IDPay Silent Flow · SDK Web POC</p>
      </div>
    </header>
  );
}
